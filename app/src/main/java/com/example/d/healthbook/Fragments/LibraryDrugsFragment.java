...
import com.example.d.healthbook.Adapters.RecyclerAdapterDrugs;
...
public class LibraryDrugsFragment extends Fragment {
    private ResponseLibraryProtocol registeredUser;
    private RecyclerView mRecyclerView;
    private RecyclerAdapterDrugs recyclerDoctorListAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        setHasOptionsMenu(true);
        return inflater.inflate(R.layout.library_drugs_fragment, container, false);
...
//        App.getInstance().changeToolbarTitle((AppCompatActivity) getActivity(), "Список врачей");
        ...
        mRecyclerView = (RecyclerView) view.findViewById(R.id.library_drugs_recycler);
...
//    }
    ...
    public void seeDrugsMethod() {
        App.getApi().seeLibraryDrugs().enqueue(new Callback<ResponseLibraryProtocol>() {
            @Override
...
//                    Toast.makeText(getActivity(), "SUCCESS", Toast.LENGTH_LONG).show();
                    ...
                    recyclerDoctorListAdapter = new RecyclerAdapterDrugs(registeredUser.getDocuments(), getActivity());
