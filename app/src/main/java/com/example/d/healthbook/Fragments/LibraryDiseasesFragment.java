...
import com.example.d.healthbook.Adapters.RecyclerAdapterDisease;
...
public class LibraryDiseasesFragment extends Fragment {
    private ResponseLibraryProtocol registeredUser;
    private RecyclerView mRecyclerView;
    private RecyclerAdapterDisease recyclerDoctorListAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        setHasOptionsMenu(true);
        return inflater.inflate(R.layout.library_deseases_fragment, container, false);
...
//        App.getInstance().changeToolbarTitle((AppCompatActivity) getActivity(), "Список врачей");
        ...
        mRecyclerView = (RecyclerView) view.findViewById(R.id.library_deseases_recycler);
...
//    }
    ...
    public void seeDiseaseMethod(String id) {
        App.getApi().seeLibraryDisease().enqueue(new Callback<ResponseLibraryProtocol>() {
            @Override
...
//                    Toast.makeText(getActivity(), "SUCCESS", Toast.LENGTH_LONG).show();
                    ...
                    recyclerDoctorListAdapter = new RecyclerAdapterDisease(registeredUser.getDocuments(), getActivity());
