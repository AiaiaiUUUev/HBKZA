        ...
        searchBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (checkAutocomplete) {
                    ...
                    ((SearchDoctorsFragment) ((ViewPagerFragment) getActivity()
                            .getSupportFragmentManager()
                            .findFragmentById(R.id.changable_fragment_container)
                    ).customPagerAdapter.getCurrentFragment()).
                            seeDoctorFilterMethod("1", specialityAutocompleteTV, titleClicnic);
...
//                }
    ...
    public void setRealmItem() {
        ...
        if (clickedFilterItemses.isEmpty()) {
            mRealm.beginTransaction();
            ClickedFilterItems clickedFilterItemses2 = mRealm.createObject(ClickedFilterItems.class);
